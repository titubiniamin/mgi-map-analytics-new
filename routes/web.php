...
Route::group(['middleware' => 'auth'], function(){
    ...
    Route::resource('dealers', Backend\DealerController::class)->except(['show']);
    Route::get('all-dealers', [DealerController::class, 'allDealers'])->name('allDealers');
    Route::get('get-dealer-list', [Backend\DealerController::class, 'getDealerList'])->name('getDealerList');
    ...
    ///inventory
		Route::get('/inventory-item-create', [ItemController::class,'create'])->name('inventory.item.create');
		Route::get('/inventory-item-index', [ItemController::class,'index'])->name('inventory.item.index');
		Route::post('/inventory-item-store', [ItemController::class,'store'])->name('inventory.item.store');
		Route::get('/inventory-item-update', [ItemController::class,'update'])->name('inventory.item.update');
		Route::get('/inventory-item-get-list', [ItemController::class,'getItemList'])->name('inventory.item.get.list');
